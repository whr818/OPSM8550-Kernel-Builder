...
resolve_build_profile() {
  ...
  case "$profile" in
    ...
    "SM8550 | OnePlus 11 / 12R | LineageOS (recommended)")
      ...
      SOURCE_LAYOUT="community-flat"
      KERNEL_REPO_OVERRIDE="https://github.com/LineageOS/android_kernel_oneplus_sm8550.git"
      MODULES_REPO_OVERRIDE="https://github.com/LineageOS/android_kernel_oneplus_sm8550-modules.git"
      ;;
    "SM8550 | OnePlus 11 / 12R | crDroid")
